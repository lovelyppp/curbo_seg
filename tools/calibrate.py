...
import time
import cv2
from tools.realsenseD435i import RealsenseD435i
...
# --------------- Setup options ---------------
tcp_host_ip = "192.168.50.139"  # IP and port to robot arm as TCP client (UR5)
tcp_port = 30002
rtc_host_ip = "192.168.50.139"  # IP and port to robot arm as real-time client (UR5)
rtc_port = 30003
workspace_limits = np.asarray(
    [[0.3, 0.748], [0.05, 0.4], [-0.2, -0.1]]
...
#               False, None, None)
robot = UR_Robot(tcp_host_ip, tcp_port, workspace_limits)
robot.open_gripper()
